    ...
    <div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
			<div className='w-full p-6 rounded-lg shadow-md bg-white bg-clip-padding '>
				<h1 className='text-3xl font-semibold text-center text-gray-300'>
					Sign Up <span className='text-green-500'> SurveyMonkey</span>
				</h1>
				...
				<form onSubmit={handleSubmit}>
					...
					<div>
						<button className='btn btn-block btn-sm mt-2 border bg-green-500 text-white h-10' disabled={loading}>
